...
;
;
function mapUserRoleToDashboardRole(role) {
    switch(role){
        case 'super_admin':
        case 'school_admin':
            return 'admin';
...
function DashboardLayout({ children }) {
    ...
    const { data: session, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSession"])();
    ...
    const user = session?.user ? {
        firstName: session.user.firstName || 'Benutzer',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aced37a5._.js.map