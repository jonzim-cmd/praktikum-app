...
function LoginForm() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if (!redirectTo) {
                const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSession"])();
